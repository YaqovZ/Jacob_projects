This is a simple web scraper using Beautiful Soup extracting data of Premier League matches. You can just run the file! I shall make them proper py files in the future.
